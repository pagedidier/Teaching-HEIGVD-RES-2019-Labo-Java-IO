...
public class Application implements IApplication {
  ...
  void storeQuote(Quote quote, String filename) throws IOException {
    ...
    for (String quoteTagName : quote.getTags()){
      path += File.separator +quoteTagName;
    }
    File quoteFolder = new File(path);
    quoteFolder.mkdirs();
    ...
    if(quoteFile.createNewFile()){
      ...
      FileOutputStream outputStream = new FileOutputStream(quoteFile);
      byte[] strToBytes = quote.getValue().getJoke().getBytes();
